// ==================================================
// app/dashboard/page.tsx  (Dashboard principale + LearningPath)
// ==================================================
'use client';
...
import { Flame, Star, CalendarCheck, LogOut } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const logoutButton = (
    <button
      onClick={logout}
      className="inline-flex items-center gap-2 rounded-2xl border border-stone-200 bg-white/50 px-3 py-2 text-sm shadow-sm backdrop-blur transition hover:shadow-md"
    >
    ...
    >
      <div className="flex flex-col items-center px-6 py-8 bg-[url('/kuro.svg')] bg-no-repeat bg-[length:180px] bg-[top_1rem_left_1rem] min-h-screen">
        ...
        <footer className="mt-auto flex w-full max-w-4xl items-center justify-between py-6 text-xs text-stone-500">
          <span>
            &copy; {new Date().getFullYear()} GoLingo • Tutti i diritti
            riservati
          </span>
